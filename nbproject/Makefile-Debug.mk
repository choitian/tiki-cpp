...
${OBJECTDIR}/tools/syntax/grammar/grammer.o: tools/syntax/grammar/grammer.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tools/syntax/grammar/grammer.o tools/syntax/grammar/grammer.cpp

${OBJECTDIR}/tools/util/commons.o: tools/util/commons.cpp
	${MKDIR} -p ${OBJECTDIR}/tools/util
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tools/util/commons.o tools/util/commons.cpp
...
${OBJECTDIR}/tools/syntax/grammar/grammer_nomain.o: ${OBJECTDIR}/tools/syntax/grammar/grammer.o tools/syntax/grammar/grammer.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tools/syntax/grammar/grammer_nomain.o tools/syntax/grammar/grammer.cpp;\
	else  \
...
${OBJECTDIR}/tools/util/commons_nomain.o: ${OBJECTDIR}/tools/util/commons.o tools/util/commons.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tools/util/commons_nomain.o tools/util/commons.cpp;\
	else  \
